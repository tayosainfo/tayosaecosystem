...
func main() {
	...
	mux.HandleFunc("/api/v1/affiliate/referrals", requireAuth(func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("/api/v1/affiliate/rewards", requireAuth(func(w http.ResponseWriter, r *http.Request) {
		rewards.mu.RLock()
